// se crea un arreglo vacio para guardar nuestros datos de la api
let globalPokemon = [];
// una variable para seleccionar nuestro container
const mainContainer = document.querySelector('.main-container');
//una variable para guardar lo que se escriba en el input
